              ...
              <table id="example3" class="table table-bordered" style="font-size: 20px;">
                ...
                <thead style="text-align: center;">
                  ...
                  <tr style="text-align: right; background-color: aquamarine;font-weight: bolder;">
                    ...
                    <td>{{ number_format($project->nilai_budget_total,2)}}</td>

                    <td>{{ number_format($project->nilai_budget_total/$nilai_total['total_luas_netto'],2)}}</td>

                    <td>{{ number_format($project->nilai_budget_total/$project->luas,2)}}</td>                    
                  ...
                  @foreach ( $project->kawasans as $key => $value )                    
                    ...
                    <tr style="text-align: right;">
                      ...
                      <td style="text-align: right;background-color: white">
                        @if ( $value->lahan_luas != "0.0")
                        {{ number_format(($value->lahan_sellable / $value->lahan_luas )* 100,2) }}
                        @else
                        0
                        @endif
                      </td>
