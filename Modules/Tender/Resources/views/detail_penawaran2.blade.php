              ...
              <table class="table table-bordered">
               ...
               <tbody>                          
                ...
                <tr>
                  ...
                  <td>
                    <input type="text" name="input_rab_id_[{{ $start}}]" class="form-control" value="{{ $tender_penawaran_detail->first()->id }}">
                ...
                @if ( count($value3->child_item) > 0 )
                  @foreach ( $value3->child_item as $key4 => $value4 )
                    ...
                    <td>{{ $value4->name }}</td>
                    <td>
                        <input type="hidden" name="input_rab_id_[{{ $start}}]" class="form-control" value="{{ $tenderpenawarandetail->first()->id }}">
                        <input type="text" name="input_rab_volume_[{{ $start }}]" class="form-control vol" value="{{ $tenderpenawarandetail->first()->volume }}" readonly>
                    </td>
